            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 cmt-3">
                        ...
                        <p className={aboutStyle['description']}>Every aspect of company, including business models, procedures, and consumer relationships, is being disrupted by digital. Our digital solutions are focused on giving you the technology to truly "With digital" as well as a transformation plan. We assist your company objectives and take care of all your business technologies, from site design and development to setting up and maintaining your brand's digital presence.</p>
