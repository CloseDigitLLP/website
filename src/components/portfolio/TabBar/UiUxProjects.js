...
export default function UiUxTab() {
    ...
    const designProjects = data.projectPairs.filter(project => project.category.includes("design"))
    
    const projectPairs = groupIntoPairs(designProjects);
